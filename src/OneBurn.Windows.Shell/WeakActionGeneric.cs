...
namespace OneBurn.Windows.Shell
{
    ...
    public class WeakAction<T> : WeakAction, IExecuteWithObject
    {
        ...
        /// </summary>
        public override bool IsAlive => (_staticAction != null || Reference != null) && (_staticAction != null ? Reference == null || Reference.IsAlive : Reference.IsAlive);
        ...
        ///     <see cref="M:Preliact.Windows.Messaging.IExecuteWithObject.ExecuteWithObject(System.Object)" />
        ///     and can be useful if you store multiple <see cref="WeakAction{T}" /> instances but don't know in advance
